...
# ── ECS General & Required Variables ────────────────────────────────────────────

variable "enabled" {
  description = "Whether to create the ECS resources at all"
  type        = bool
  default     = true
}
...
variable "cluster_name" {
  description = "Name of the ECS cluster (used in names, tags, log groups, etc.)"
  type        = string
}
